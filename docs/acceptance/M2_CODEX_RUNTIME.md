...
Status: In progress. The protocol and product Workspace seams are implemented. Isolated authentication, approval routing, event-worker supervision, and real Turn recovery remain.
...
- Consume real streamed notifications in a durable Runtime worker and call the product completion boundary.
